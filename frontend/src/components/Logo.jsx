...
function Logo() {
    ...
    const arrayJudul = ["3 Ujung Mahkota", "Diamond Putih", "Diamond Hitam", "Diamond Pink"];
    const arrayIsi = ["Melambangkan 3 jenis UKM yang terdapat di UMN yaitu: Seni & Budaya, Olahraga, Sains & Sosial",
    ...
    const handlePrevButtonClick = () => {
        setJudulMakna((prevIndex) => (prevIndex - 1 + arrayJudul.length) % arrayJudul.length);
        setTeksMakna((prevIndex) => (prevIndex - 1 + arrayIsi.length) % arrayIsi.length);
    };
    ...
    return (
        <div class="logo">
            ...
            <div class="text">
                ...
                <p>Serah Tahunan merupakan kegiatan tahunan yang dilaksanakan oleh Badan Eksekutif Mahasiswa Universitas Multimedia Nusantara
                   dengan tujuan untuk memberikan apresiasi terhadap pengurus Unit Kegiatan Mahasiswa (UKM) Seni dan Budaya, Olahraga, serta Sains dan Sosial 
                   generasi yang telah menjabat serta kegiatan serah terima jabatan (sertijab) kepengurusan</p>
            </div>
