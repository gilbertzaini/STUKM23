            ...
            <div className="navbar">
                <div className="navbar-pembungkus">
                    <div className="box-logo">
                        ...
                        <Link to="/" className="text-stukm">STUKM 2023</Link>
                    </div>
                    <div className="box-option-navbar">
                        <ScrollLink className='navbar-vote'
                            to="votingForm"
                            spy={true}
                            smooth={true}
                            offset={-70}
                        ...
                        <Link to="/ukm" className="navbar-ukm">UKM</Link>
                        <Link to="/sponsor" className="navbar-sponsor">SPONSOR</Link>
